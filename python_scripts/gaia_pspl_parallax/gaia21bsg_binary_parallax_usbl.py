...
usbl = USBL_model.USBLmodel(your_event, fancy_parameters = fancy, parallax=['Full',2.45935387e+06])
...
if perform_long_fit == False:
    ...
    # Save it
    np.save('results_USBL_parallax_gaia21bsg.npy', fit_2.fit_results['DE_population'])

else:
    # Use the precomputed Differential Evolution (DE) results:
    fit_2.fit_results['DE_population'] = np.load('results_USBL_parallax_gaia21bsg.npy')
