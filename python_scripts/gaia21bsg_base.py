...
data_4 = np.loadtxt('data/reduced_ztf.dat',delimiter=' ')   # will need to use func to convert HJD
...
data_5 = np.loadtxt('data/reduced_gaia.dat',delimiter=' ')    # will need to use func to convert HJD
