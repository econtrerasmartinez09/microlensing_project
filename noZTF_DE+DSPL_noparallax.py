...
dspl = DSPL_model.DSPLmodel(your_event,fancy_parameters=fancy,parallax=['None',2.45935341e+06])
fit_2 = MCMC_fit.MCMCfit(dspl)
fit_2.fit()
...
plot_lightcurves(dspl,fit_2.fit_results['best_model'])
plt.show()

plot_geometry(dspl,fit_2.fit_results['best_model'])
plt.show()