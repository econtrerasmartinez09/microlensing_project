...
# loading in the proprietary lco data; format is the same across all three, so just change file

# for example, the 'star_79874_Gaia21bsg_ip.dat' file

# the first three cols are the data (HJD), mag, mag_err
lco = np.loadtxt('star_790874_Gaia21bsg_ip.dat',usecols=(0,1,2))
np.savetxt('reduced_star_790874_ip.dat',lco,fmt='%s')