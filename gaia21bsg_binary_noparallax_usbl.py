...
if perform_long_fit == True:
    ...
    # Save it
    np.save('results/ZTF_USBL_parallax_gaia21bsg.npy', fit_2.fit_results['DE_population'])

else:
    # Use the precomputed Differential Evolution (DE) results:
    fit_2.fit_results['DE_population'] = np.load('results/ZTF_USBL_noparallax_gaia21bsg.npy')
